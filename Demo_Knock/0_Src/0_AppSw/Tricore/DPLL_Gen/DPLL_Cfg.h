...
#define GENERATED_PLL    (512) /** !<micro ticks generated for each tooth (up to 1024) */
...
#define IFX_VRS_MAX_NTEETH (IFX_VRS_NCYCLES*GENERATED_PLL)
...
#define VRS_MICROTICS_REV (IFX_VRS_NTEETH * GENERATED_PLL)
