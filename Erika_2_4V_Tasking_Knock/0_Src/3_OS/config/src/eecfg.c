 ...
 **************************************************************************/
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        {IFX_OSTASK_COUNTER, IFX_OSTASK_ALARM_1MS, EE_ALARM },
        {IFX_OSTASK_COUNTER, IFX_OSTASK_ALARM_5MS, EE_ALARM },
        {IFX_OSTASK_COUNTER, IFX_OSTASK_ALARM_10MS, EE_ALARM },
        {IFX_OSTASK_COUNTER, IFX_OSTASK_ALARM_20MS, EE_ALARM },
        {IFX_OSTASK_COUNTER, IFX_OSTASK_ALARM_50MS, EE_ALARM },
        {IFX_OSTASK_COUNTER, IFX_OSTASK_ALARM_100MS, EE_ALARM }
    };
 ...
 **************************************************************************/
    const EE_oo_action_ROM_type   EE_oo_action_ROM[EE_ACTION_ROM_SIZE] = {
        ...
        {EE_ACTION_TASK    , IFX_OSTASK_1MS, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , IFX_OSTASK_5MS, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , IFX_OSTASK_10MS, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , IFX_OSTASK_20MS, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , IFX_OSTASK_50MS, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , IFX_OSTASK_100MS, 0U, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 }
    };
 ...
 **************************************************************************/
     ...
     *         {  };
    */
    static const EE_TID EE_oo_autostart_task_mode_TRICORE_CPU[EE_OO_AUTOSTART_TASK_MODE_TRICORE_CPU_SIZE] = 
        { IFX_OSTASK_INIT };
